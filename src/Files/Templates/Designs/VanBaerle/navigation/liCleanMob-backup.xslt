    ...
    <li>
      ...
      <xsl:choose>
        <xsl:when test="count(Page[@ItemType!='Tab' or string-length(@ItemType)=0]) > 0">
          <a href="#" class="dropdown-toggle hidden-lg hidden-md {concat('dropdown-toggle-',@AbsoluteLevel)}" data-toggle="dropdown" role="button" aria-expanded="false"><span class="caret"></span></a>
