...
+function (t) {
  ...
  function e(e) {
    e && 3 === e.which || (t(o).remove(), t(s).each(function () {
      var n = t(this), o = i(n), s = {relatedTarget:this};
  ...
  a.VERSION = "3.3.2", a.prototype.toggle = function (n) {
    ...
    if ( /(38|40|27|32)/.test(e.which) && !/input|textarea/i.test(e.target.tagName) ) {
      ...
      if ( e.preventDefault(), e.stopPropagation(), !n.is(".disabled, :disabled") ) {
        ...
        var r = " li:not(.disabled):visible a", d = o.find('[role="menu"]' + r + ', [role="listbox"]' + r);
        if ( d.length ) {
  ...
  var r = t.fn.dropdown;
  t.fn.dropdown = n, t.fn.dropdown.Constructor = a, t.fn.dropdown.noConflict = function () {return t.fn.dropdown = r, this}, t(document).on("click.bs.dropdown.data-api", e).on("click.bs.dropdown.data-api", ".dropdown form",
      function (t) {t.stopPropagation()}).on("click.bs.dropdown.data-api", s, a.prototype.toggle).on("keydown.bs.dropdown.data-api", s, a.prototype.keydown).on("keydown.bs.dropdown.data-api", '[role="menu"]', a.prototype.keydown).on("keydown.bs.dropdown.data-api", '[role="listbox"]', a.prototype.keydown)
}(jQuery), +function (t) {
  "use strict";
  function e(e, n) {
    return this.each(function () {
  ...
  }, i.prototype.resetScrollbar = function () {this.$body.css("padding-right", 0)}, i.prototype.measureScrollbar = function () {
  ...
  n.VERSION = "3.3.2", n.TRANSITION_DURATION = 350, n.DEFAULTS = {toggle:!0}, n.prototype.dimension = function () {
